        ...
        for stamp in stamps:
            ...
            if (count == 0):
                ...
                if (count == 0):
                    ...
                    query = "INSERT INTO `raceresults` (`plate`,`sicard_id`,`name`,`riderid`,`raceid`,`category`,`ranktotal`,`t1`,`t11`,`t2`,`t22`,`t3`,`t33`,`t4`,`t44`,`t5`,`t55`,`t6`,`t66`,`t7`,`t77`,`t8`,`t88`) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)" 
