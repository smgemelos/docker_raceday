...
$query = "SELECT a.teamname, a.place, a.total, a.r1, a.r2, a.r3, a.r4, a.r5, a.r6, a.r7, a.r8 FROM teamresults a  WHERE series=16 ORDER BY a.place ";
