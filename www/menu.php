	    ...
	    <ul  class="nav navbar-nav navbar-right">
	    	...
	    	<li <?php if( ($page == "admin") OR ($page=="loadregfile") ) {echo 'class="active"';} ?> class="dropdown">
        			...
        			<ul class="dropdown-menu">
          				...
          				<li <?php if($page == "adminstages") {echo 'class="active"';} ?> ><a href="admin_activestage.php">Active Stages</a></li>
          				<li <?php if($page == "adminbeacon") {echo 'class="active"';} ?> ><a href="admin_beacontime.php">Beacon Setup</a></li>
